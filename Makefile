...
LIBS = -lresolv -lnsl -lpthread\
	/home/nilesh/Documents/assgn1/libunp.a\
	
FLAGS = -g -O2

CFLAGS = ${FLAGS} -I/home/nilesh/Documents/assgn1/lib

all: client server echo_cli time_cli 


time_cli: time_cli.o readline.o
	${CC} ${FLAGS} -o time_cli time_cli.o readline.o ${LIBS}
...
server: tcpechotimesrv.o readline.o time_srv.o echo_srv.o
	${CC} ${FLAGS} -o server tcpechotimesrv.o readline.o time_srv.o echo_srv.o ${LIBS}
tcpechotimesrv.o: tcpechotimesrv.c
	${CC} ${CFLAGS} -c tcpechotimesrv.c


client: tcpechotimecli.o sigchldwait.o
	${CC} ${FLAGS} -o client tcpechotimecli.o sigchldwait.o ${LIBS}
...
readline.o: /home/nilesh/Documents/assgn1/threads/readline.c
	${CC} ${CFLAGS} -c /home/nilesh/Documents/assgn1/threads/readline.c
...
clean:
	rm echo_cli echo_cli.o server tcpechotimesrv.o client tcpechotimecli.o time_cli time_cli.o readline.o time_srv.o echo_srv.o
